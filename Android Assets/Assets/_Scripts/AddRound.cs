...
public class AddRound : MonoBehaviour {
    ...
    void FindNececaryObjects() {
        ...
        inactivation_bonusesGO = GameObject.Find("Btn_Bonuses");
        ...
        // main sub-menus
        bonus_SubMenu_GO = GameObject.Find("Img_Bonuses_Submenu");
        ...
        bonus_SubMenu_GO.SetActive(false);
    ...
    public void btn_open_BonusSubmenu()
    {
        bonus_SubMenu_GO.SetActive(true);
    }

    public void btn_close_BonusSubmenu()
    {
        bonus_SubMenu_GO.SetActive(false);
    }
    #endregion
    ...
    public void btn_aditionalPoints_changeToNegative ()
    {
        if (additionalPoints.text == "") return;

        int currVal = int.Parse(additionalPoints.text);
        currVal *= -1;
        additionalPoints.text = currVal.ToString();
